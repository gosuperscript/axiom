...
final class SourceCompilationTest extends TestCase
{
    private static function compilation(
        ...
        ?Closure $compileSubprogram = null,
        ...
        return new SourceCompilation(
            ...
            $compileSubprogram ?? fn(\Superscript\Axiom\Subexpression $expression, array $parameters): Result => Err(new TypeMismatch('No subprogram expected.')),
